...
"""
#
# Este script Python é responsável por treinar uma rede neural convolucional para a detecção
# de expressões faciais, utilizando a base de dados FER-2013. A arquitetura final da rede 
# (estrutura de camadas) apresentada neste Script foi proposta por Gustavo Cassel ao longo
# de muitos testes no Google Colab.
# 
# Alguns trechos do script, como a carga do dataset FER-2013 para a memória RAM através da biblioteca
# Pandas, assim como a conversão de dados Pandas -> NumPy, foram baseados e inspirados no artigo
# do Medium: [Deep Learning Lab] Episode-3: fer2013, de Furkan Kınlı. Disponível no link:
# https://medium.com/@birdortyedi_23820/deep-learning-lab-episode-3-fer2013-c38f2e052280
#
# Alguns trechos também foram baseados na pesquisa apresentada no curso Reconhecimento de Emoções
# com TensorFlow 2.0 e Python, disponível na Udemy, dos professores Jones Granatyr e Gabriel Alves.
# Link do curso:
...
#
# Gera array de faces onde cada face possui tamanho 48 x 48
#
...
#
# Converte para um array numpy de 4 posições, no formato
...
#
# Constrói o generator que faz modificações nas imagens de entrada na rede
#
...
#
# Constrói o modelo da Rede Neural Convolucional propriamente dita
#
model = Sequential()
...
#
# Cria callbacks que são acionados durante o treino da rede neural
# 
...
#
# Salva o modelo em disco em formato humano-legível
#
